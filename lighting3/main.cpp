/* Codice ricavato dal tutorial sui Materials della categoria Lighting,	
 * partendo dal codice ottenuto dai tutorial precedenti.
 * Pagina web di riferimento: https://learnopengl.com/Lighting/Materials
 */
...
//	glBindVertexArray(0);
	...
	while(!glfwWindowShouldClose(window)){
		...
		glm::vec3 cubeColor;
		cubeColor.x = sin(glfwGetTime() * 2.0f);
		cubeColor.y = sin(glfwGetTime() * 0.7f);
		cubeColor.z = sin(glfwGetTime() * 1.3f);
		
		glm::vec3 diffuseColor = cubeColor * glm::vec3(0.5f);
