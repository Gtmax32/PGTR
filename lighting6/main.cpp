/* Codice ricavato dal tutorial sulle Multiple Lights della categoria Lighting,	
 * partendo dal codice ottenuto dai tutorial precedenti.
 * Pagina web di riferimento: https://learnopengl.com/Lighting/Multiple-lights
 */
...
//	glBindVertexArray(0);
	...
	while(!glfwWindowShouldClose(window)){
		...
		shader.Use();
		//COMPONENTI DIRECTION LIGHT
		shader.setVec3("dirLight.direction", -0.2f, -1.0f, -0.3f);
		shader.setVec3("dirLight.ambient", 0.05f, 0.05f, 0.05f);
		shader.setVec3("dirLight.diffuse", 0.4f, 0.4f, 0.4f);
		shader.setVec3("dirLight.specular", 0.5f, 0.5f, 0.5f);
		//COMPONENTI POINTLIGHTS
		...
		shader.setFloat("pointLights[1].quadratic", 0.0032f);
		...
		shader.setFloat("pointLights[2].quadratic", 0.0032f);
		...
		shader.setFloat("pointLights[3].quadratic", 0.0032f);
		//COMPONENTI SPOTLIGHT
